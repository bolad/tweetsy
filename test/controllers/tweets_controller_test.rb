...
class TweetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tweet" do
    assert_difference('Tweet.count') do
      post tweets_url, params: { tweet: { message: @tweet.message, pack_id: @tweet.pack_id } }
    end
  ...
  test "should update tweet" do
    patch tweet_url(@tweet), params: { tweet: { message: @tweet.message, pack_id: @tweet.pack_id } }
